...
def index():
    ...
    firebaseConfig = {
    "apiKey": "AIzaSyCtZokvZbDliVc2CVbQFYwcBjV6Ckv9kqM",
    "authDomain": "oficina2.firebaseapp.com",
    "databaseURL": "https://oficina2.firebaseio.com",
    "projectId": "oficina2",
    "storageBucket": "oficina2.appspot.com",
    "messagingSenderId": "317855692977",
    "appId": "1:317855692977:web:fef61a0d285b8a32"
    }
    firebase = pyrebase.initialize_app(firebaseConfig)
    data = firebase.database()

    band = MiBand2("DD:39:AA:42:26:1A")
    ...
    if(hr < 65):
        warn = "Seus batimentos estao baixos! Voce ja tomou seus remedios hoje ?"
    elif(hr > 85):
        warn = "Seus batimentos estao rapidos demais! Sente-se, acalme e veja esse video!: https://www.youtube.com/watch?v=-CjARM1yaoI \n Procure tomar seus remedios e ligar para alguem de confianca !"
    else:
        warn = "Seus batimentos estao normais, continue calmo sempre ! :D"


    return (render_template('home.html', hr = hr, warn = warn))
...
def home():
    ...
    users = data.child('hr').get()
    hr = users.val()

    if(hr < 65):
        warn = "Seus batimentos estao baixos! Voce ja tomou seus remedios hoje ?"
    elif(hr > 85):
        warn = "Seus batimentos estao rapidos demais! \n Procure tomar seus remedios e ligar para alguem de confianca ! Sente-se, acalme e veja esse video!: https://www.youtube.com/watch?v=-CjARM1yaoI"
    else:
        warn = "Seus batimentos estao normais, continue calmo sempre ! :D"
